@include('adm.catalogo.descargas.partials.header')
				...
				<h5>Descargas de Cataáogos</h5>					
				<div class="divider"></div>
				<div class="col s12">

					<form method="POST"  enctype="multipart/form-data" action="{{action('PrecioController@update', $descarga->id)}}" class="col s12 m8 offset-m2 xl10 offset-xl1">
						{{ csrf_field() }}    
						{{ method_field('PUT')}}  
						...
						<div class="row">
							...
							<div class="input-field col s6">
								...
								<input id="icon_prefix" type="text" class="validate" name="nombre" value="{{$descarga->nombre}}" >
