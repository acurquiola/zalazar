@include('adm.productos.galeria.partials.header')
				...
				<form method="POST"  enctype="multipart/form-data" action="{{action('GaleriaController@store')}}" class="col s12 m8 offset-m2 xl10 offset-xl1">
					...
					<div class="row">
						<h5>Crear Galeria de la subfamilia {!! $subfamilia->nombre !!}</h5>					
						<div class="divider"></div>
						<div class="file-field input-field">
						<h6>Cargue las imágenes que conformarán la galería de la subfamilia</h6>
							<div class="btn">
								<span>Imágenes</span>
						...
						<input type="hidden" name="subfamilia_id" value="{{$subfamilia->id}}">
						<div class="right">
							<a href="{{action('SubfamiliaController@index', ['subfamilia' => $subfamilia->id ])}}" class="waves-effect waves-light btn">Cancelar</a>
